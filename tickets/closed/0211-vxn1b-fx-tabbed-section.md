...
>
> **SUPERSEDED (2026-07-31) by [[E039]] / [[0220]].** FX becomes a single
> **global** chain on the FX/Mixer/Global tab — both layers mix in via layer
> balance, not per-layer FX
> ([ADR 0002](../../vxn-1b/adrs/0002-vxn1b-dual-layer.md)). The FX tab widgets are
> **inherited by 0220**. Closed as superseded.
