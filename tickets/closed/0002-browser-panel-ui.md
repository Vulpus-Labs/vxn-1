...
- [ ] **Save form (bottom of panel):**
  ...
  - [ ] **New Folder** button — calls `create_user_folder("New Folder")`,
    ...
    widget itself ships in 0003; this ticket just wires the "enter rename
...
- This is the central UI ticket. Inline rename and the context menu live in
  0003 — but this ticket must leave hooks: a `rename_target: SyncSignal<Option<RenameTarget>>`
