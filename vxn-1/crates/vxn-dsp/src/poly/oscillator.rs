//! Structure-of-arrays poly oscillator kernel for the synthesis hot path.
//!
...
//! f32, so 8 channels = 2 SIMD lanes deep). Waveform is a *per-layer* parameter,
//! hoisted outside the lane loop — the inner loop has no data-dependent branches.
//!
...
#[inline(always)]
pub(super) fn pblep(t: f32, dt: f32) -> f32 {
