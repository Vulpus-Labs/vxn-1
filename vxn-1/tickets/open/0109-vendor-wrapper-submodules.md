...
are consumed by the wrapper CMake (ticket 0110).
...
0110) overrides that path to point at our `vendor/vst3sdk`
...
in xtask (ticket 0111) behind `--format vst3` so a fresh clone
