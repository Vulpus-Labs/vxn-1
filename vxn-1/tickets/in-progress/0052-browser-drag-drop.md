...
HTML5 drag-drop implementation in the 0050 browser. User presets
...
- [ ] Drop posts `UiEvent::MovePreset { source: <preset path>,
      target: <FolderKey> }`. Same target as 0051's Move to menu.
...
to HTML5 DnD. Once 0052 lands, archive 0032 to closed with a pointer
