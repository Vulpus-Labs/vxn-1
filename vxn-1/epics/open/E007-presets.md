...
Decisions recorded in [ADR 0005](../../adrs/0005-vxn1-presets.md). This is the
...
- [x] [0024 — Preset format + (de)serialization](../../tickets/open/0024-preset-format.md)
- [x] [0025 — Factory bank infrastructure + starter set](../../tickets/open/0025-factory-preset-infra.md)
- [x] [0026 — Preset load/save integration + host notify](../../tickets/open/0026-preset-load-save-integration.md)
- [ ] [0027 — Preset browser UI](../../tickets/open/0027-preset-browser-ui.md)
- [ ] [0028 — Jupiter-8 factory preset port](../../tickets/open/0028-jp8-preset-port.md)
