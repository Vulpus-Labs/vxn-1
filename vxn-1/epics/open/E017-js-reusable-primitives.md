...
test net from [E015](E015-js-test-framework.md) and lands cleanest
after the [E016](E016-js-post-e014-cleanup.md) boundary cleanup
...
The 0075 close-out audit (E014) noted that the primitive factories
...
- [ ] [0086 — Inject `send` into primitive factories](../../tickets/open/0086-inject-send.md)
- [ ] [0087 — Wrap params descriptor as a model object](../../tickets/open/0087-params-model.md)
- [ ] [0088 — Controller-as-factory + primitive registry](../../tickets/open/0088-controller-factory.md)
- [ ] [0089 — Unify primitive return shape; lift addCtl out of composite](../../tickets/open/0089-primitive-contract.md)
- [ ] [0090 — Source-tree reorganisation into primitives/ controller/ browser/ bridge/](../../tickets/open/0090-source-tree-reorg.md)
- [ ] [0091 — Modal mount-target audit](../../tickets/open/0091-modal-mount-target.md)
