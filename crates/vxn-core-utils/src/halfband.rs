...
// ---------------------------------------------------------------------------
// Interpolating half (moved from vxn2-dsp by ticket 0224).
//
// The decimator above and this interpolator share one `DEFAULT_TAPS` /
// `DEFAULT_CENTRE` table — there is no second tap set. They lived in separate
// crates only because vxn-2 was the sole upsampler.
// ---------------------------------------------------------------------------
...
mod tests {
    ...
    // ---- interpolating half (moved from vxn2-dsp, ticket 0224) ----
