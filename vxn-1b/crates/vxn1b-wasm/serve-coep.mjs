...
// for SharedArrayBuffer (ticket 0292). Serves the `cargo xtask web` bundle
// (target/web-dist-vxn1b/) — the page that boots the WebHost + controller.
//
//   cargo xtask web                    (build the bundle first)
//   node serve-coep.mjs [port] [dir]   (default 8080, target/web-dist-vxn1b)
...
const ROOT = process.argv[3]
  ...
  : normalize(join(HERE, "../../../target/web-dist-vxn1b"));
