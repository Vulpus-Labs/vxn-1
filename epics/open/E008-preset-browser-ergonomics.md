...
Turn the basic preset bar shipped by E007 / 0027 into a working **preset
...
Decisions recorded in [ADR 0006](../../adrs/0006-vxn1-preset-browser-ergonomics.md).
This epic layers on E007's format + factory + load/save corpus; it does not
touch the format or the audio path.

## Background

E007 shipped the preset *plumbing*: format (0024), embedded factory (0025),
...
- **Browser panel UI (0030):** two-pane folders | presets layout, search
...
- **Edit affordances (0031):** inline rename (Enter commit, Escape cancel),
...
- **Favourites** and **preset morphing** (already deferred in E007).
...
- [x] [0029 — User folder support (engine)](../../tickets/open/0029-user-folder-support-engine.md)
- [ ] [0030 — Browser panel UI](../../tickets/open/0030-browser-panel-ui.md)
- [ ] [0031 — Edit affordances: rename, delete, move, tag editor](../../tickets/open/0031-browser-edit-affordances.md)
- [ ] [0032 — Drag-and-drop preset → folder](../../tickets/open/0032-browser-drag-drop.md)

## Dependency order

```text
0029 (engine IO) ──> 0030 (browser panel)
                         ├──> 0031 (rename / delete / move / tag edit)
                         └──> 0032 (drag-drop)
```

0029 is foundational — it adds the IO surface every UI ticket calls. 0030
ships a working browser (search, save, double-click load) on top of it.
0031 and 0032 are independent of each other on top of 0030; 0031 is the
must-have edit path, 0032 is the nice-to-have layered atop because vizia
mouse-model fragility may bite (ADR 0006 §8) — 0031's Move-to menu is the
