...
recorded in [ADR 0004](../../vxn-1/adrs/0004-vxn1-osc-interaction-and-fixed-panels.md).
...
- **Fixed-panel UI (0001):** rebuild the editor as the panels below.
...
- [ ] 0020 — Sub-sample BLEP-softened hard sync
- [ ] 0021 — Poly ring modulator + drop brown noise
- [ ] 0022 — Param model + routing rewrite (matrix rip-out)
- [ ] [0001 — Fixed-panel editor rebuild](../../tickets/open/0001-fixed-panel-ui.md)

## Dependency order

```text
0020 (BLEP sync) ── independent (DSP only) ──┐
0022 (param/routing rewrite) ──> 0021 (ring, uses RingLevel) ──> 0001 (UI)
```
...
0021 and 0001 consume. 0020 touches only `vxn-dsp` and can land any time.
