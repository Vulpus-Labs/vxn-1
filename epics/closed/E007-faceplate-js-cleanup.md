...
- [ ] 0063 — Typed sender API for IPC opcodes
- [ ] 0064 — `discrete(id, plain)` helper collapses gesture brackets
- [ ] 0065 — `variantIdx` helper for variant-by-name lookups
- [ ] 0066 — Fold free-run and notch dims into DIM_RULES
- [ ] 0067 — Group dispatch state into one `model` object
- [ ] 0068 — Extract `wireFaderDrag`
- [ ] 0069 — Extract `attachValuePop`
- [ ] 0070 — Small helpers and `tgRow` miss in keysPanel
- [ ] 0071 — Hoist magic numbers and `TWIN_TOP_CT`
- [ ] 0072 — One unified `cells` list with `layered: bool`
- [ ] 0073 — Move `browserPanel` to `browser.js`
- [ ] 0074 — Unbundle Save-As modal from delete-confirm
- [ ] 0075 — Re-review faceplate JS against the original findings
