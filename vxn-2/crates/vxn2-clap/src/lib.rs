...
use vxn2_engine::{
    ParamKind, ParamModel, ScopedFlushToZero, TOTAL_PARAMS, desc_for_clap_id, module_for_clap_id,
...
impl<'a> PluginAudioProcessor<'a, VxnShared, VxnMainThread<'a>> for VxnAudioProcessor<'a> {
    ...
    fn process(
        ...
        // Stop→play: realign a host-synced global LFO (LFO1) to the bar grid so
