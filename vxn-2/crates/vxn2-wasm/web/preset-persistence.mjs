// Async-storage <-> sync-controller bridge for user presets (E030 / 0159).
//
// IndexedDB is async; the vxn-2 controller + its user store are synchronous,
...
//
// This module is the JS owner; the wasm side (vxn2-web-controller) owns the
// cache + journal, and preset-storage.mjs is the raw IndexedDB primitive. ONE
// code path: the Node test drives this class against a fake-IDB, the same
