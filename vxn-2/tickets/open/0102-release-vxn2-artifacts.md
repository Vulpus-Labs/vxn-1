...
Stretch ticket of [E009](../../epics/open/E009-windows-parity.md).
...
Stretch / deferrable — the core E009 deliverable is the
`build-windows.yml` CI artifact (0100), not release packaging. Port of
