...
vxn-1's `staticlib` crate-type is added by E020 0108 — reuse it here
rather than duplicating.

## Design

- Wire the 0103 scaffold to vxn-1: feed `vxn-clap`'s static archive to
...
- No change to vxn-1 DSP, params, editor, or the CLAP behaviour (only
  `vxn-clap`'s crate-type gains `staticlib`, via E020 0108).
